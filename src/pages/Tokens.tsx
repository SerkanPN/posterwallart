      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-[2rem] mb-12 flex items-center justify-between shadow-2xl">
          ...
          <div className="text-right">
            ...
            <p className="text-xs font-bold text-indigo-400 uppercase">Verified Creator</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {TOKEN_PACKS.map((pack) => (
            <div 
              key={pack.id} 
              className={`relative bg-zinc-900 border ${pack.popular ? 'border-indigo-500 ring-1 ring-indigo-500/50' : 'border-zinc-800'} p-6 rounded-[2rem] flex flex-col items-center group hover:bg-zinc-800/50 transition-all cursor-pointer`}
            ...
            >
              ...
              <div className="text-2xl font-black mb-6 text-indigo-400">${pack.price}</div>
