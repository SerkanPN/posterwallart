...
import { Sparkles, Maximize, ShoppingBag, ArrowRight, Layout, Camera, Star, Zap, Search, Music } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans">
      ...
      <section className="relative pt-24 pb-20 px-6">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-indigo-500/5 blur-[120px] rounded-full" />
        </div>
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter mb-8 leading-[0.85] uppercase">
            Art Redefined <br /> By <span className="text-indigo-500">Intelligence</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-32">
            ...
            {/* 1. KART: SPECIAL FOR YOUR ROOM */}
            <Link to="/special" className="group relative bg-zinc-900 border border-zinc-800 p-8 rounded-[32px] overflow-hidden transition-all hover:border-indigo-500/50 hover:bg-zinc-900/80">
              <div className="relative z-10 text-left">
                <div className="w-12 h-12 bg-indigo-500/10 rounded-2xl flex items-center justify-center mb-6">
                  <Camera className="w-6 h-6 text-indigo-500" />
                </div>
                <h2 className="text-2xl font-black italic tracking-tighter mb-2 uppercase text-zinc-100">AI Room Designer</h2>
                ...
                <span className="inline-flex items-center gap-2 text-indigo-500 font-black text-[10px] uppercase tracking-widest group-hover:gap-4 transition-all">
                  Design For Room <ArrowRight className="w-3 h-3" />
                </span>
              </div>
            </Link>

            {/* 2. KART: HD CREATOR LAB */}
            <Link to="/lab" className="group relative bg-zinc-900 border border-zinc-800 p-8 rounded-[32px] overflow-hidden transition-all hover:border-indigo-500/50 hover:bg-zinc-900/80">
              <div className="relative z-10 text-left">
                <div className="w-12 h-12 bg-indigo-500/10 rounded-2xl flex items-center justify-center mb-6">
                  <Sparkles className="w-6 h-6 text-indigo-500" />
                </div>
                <h2 className="text-2xl font-black italic tracking-tighter mb-2 uppercase text-zinc-100">HD Creator Lab</h2>
                <p className="text-zinc-500 text-xs font-bold mb-6 leading-relaxed">
                  Generate premium posters using prompts. Upscale your designs to ultra-high resolution and convert them to vector files.
                </p>
                <span className="inline-flex items-center gap-2 text-indigo-500 font-black text-[10px] uppercase tracking-widest group-hover:gap-4 transition-all">
                  Open Creator Lab <ArrowRight className="w-3 h-3" />
                </span>
              </div>
            </Link>

            {/* 3. KART: YENİ EKLENEN MÜZİK POSTERLERİ */}
            <Link 
              to="/music-posters" 
              className="group relative bg-zinc-900 border border-zinc-800 p-8 rounded-[32px] overflow-hidden transition-all hover:border-indigo-500/50 hover:bg-zinc-900/80"
              onClick={() => console.log("[LOG] Home: User selected Music Posters")}
            >
              <div className="relative z-10 text-left">
                <div className="w-12 h-12 bg-indigo-500/10 rounded-2xl flex items-center justify-center mb-6">
                  <Music className="w-6 h-6 text-indigo-500" />
                </div>
                <h2 className="text-2xl font-black italic tracking-tighter mb-2 uppercase text-zinc-100">Custom Music Posters</h2>
                <p className="text-zinc-500 text-xs font-bold mb-6 leading-relaxed">
              ...
              >
                <div className="relative aspect-square overflow-hidden rounded-[32px] bg-zinc-900 border border-zinc-800 mb-4 shadow-xl">
                  ...
                  <div className="absolute top-4 right-4 bg-zinc-950/80 backdrop-blur-md border border-zinc-800 px-2 py-1 rounded-lg">
                    <span className="text-[10px] font-black text-indigo-400 tracking-tighter">${product.price}</span>
                  </div>
                </div>
                <div className="px-2">
