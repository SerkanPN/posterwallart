  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-8 font-sans">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex w-full md:w-auto gap-4">
            <div className="relative flex-1 md:w-80">
              ...
              <input
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl py-3 pl-12 pr-4 text-xs outline-none focus:border-indigo-500 transition-all"
              />
            </div>
        ...
        {loading ? (
          <div className="flex justify-center py-20"><Sparkles className="animate-pulse text-indigo-500" /></div>
              ...
              <div key={product.id} className="relative group bg-zinc-900 rounded-[2.5rem] overflow-hidden border border-zinc-800 hover:border-zinc-700 transition-all">
                ...
                <div className="aspect-[3/4] relative overflow-hidden bg-black">
                  <img
                    ...
                    alt={product.title}
                  />
                  <div className="absolute top-4 left-4 bg-indigo-500/10 backdrop-blur-md border border-indigo-500/20 px-3 py-1 rounded-full flex items-center gap-2 z-20">
                    <Sparkles className="w-3 h-3 text-indigo-400" />
                    <span className="text-[8px] font-black text-indigo-400 uppercase tracking-widest">AI Masterpiece</span>
                  </div>
                </div>
                ...
                <div className="p-6 relative z-20">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-indigo-400 font-black text-sm">${product.price}</div>
                  </div>
